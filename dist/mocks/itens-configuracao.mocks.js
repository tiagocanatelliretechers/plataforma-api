...
exports.itensConfiguracaoDetalheMock = exports.itensConfiguracaoResumoMock = void 0;
exports.itensConfiguracaoResumoMock = [
    {
...
exports.itensConfiguracaoDetalheMock = exports.itensConfiguracaoResumoMock.map((ic) => ({
    ...ic,
    descricao: `Item de configuração do tipo ${ic.tipoIC} para ${ic.nomeComponente}.`,
    ambiente: 'PRODUCAO',
    protocolo: ic.tipoIC === 'API' ? 'HTTPS' : 'TCP',
}));
//# sourceMappingURL=itens-configuracao.mocks.js.map