...
exports.subdominiosDetalheMock = exports.subdominiosMock = void 0;
exports.subdominiosMock = [
    {
...
exports.subdominiosDetalheMock = exports.subdominiosMock.map((s) => ({
    ...s,
    descricao: `Subdomínio responsável por ${s.nomeSubdominio.toLowerCase()}.`,
}));
//# sourceMappingURL=subdominios.mocks.js.map